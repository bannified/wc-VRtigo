    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 col = tex2D(_MainTex, UnityStereoScreenSpaceUVAdjust(i.uv, _MainTex_ST)) * _TintColor; //Applying texture and blending it with the tint color
                half3 emission = tex2D(_SpecularTex, UnityStereoScreenSpaceUVAdjust(i.uv, _SpecularTex_ST)).rgb * _SpecularColor.rgb; //Applying specularity and blending it with the specular color
